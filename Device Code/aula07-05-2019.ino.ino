...
//byte mac[] = { 0x00, 0xFF, 0xBB, 0xCC, 0xDE, 0x09 };
byte mac[] = { 0x70, 0xB3, 0xD5, 0x0A, 0xC0, 0xA7 };
IPAddress ip(10, 3, 10, 109);

//byte dns[] = { 192, 168, 70, 150};
IPAddress DNSserver(192, 168, 70, 150);
IPAddress gateway(10, 3, 10, 254);
